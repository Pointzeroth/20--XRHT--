...
public:
    ...
    {
        // 模型初始化
        this->predictor_nna_ = std::make_shared<PPNCPredictor>("../config/config_ppncnna.json");
        this->predictor_nms_ = std::make_shared<PPNCPredictor>("../config/config_ppncnms.json");
